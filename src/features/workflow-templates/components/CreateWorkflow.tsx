...
// src/features/workflow-templates/components/CreateWorkflow.css
...
.create-workflow-container.dark {
...
.create-workflow-header {
  padding: 24px 32px;
  background: white;
  border-bottom: 1px solid rgba(208, 215, 230, 0.8);
  transition: all 0.3s ease;
}

.dark .create-workflow-header {
  background: #1e293b;
...
// src/features/workflow-templates/components/TemplateCard.css
...
.template-card-footer {
  margin-top: 16px;
  padding-top: 16px;
  border-top: 1px solid rgba(208, 215, 230, 0.6);
  transition: border-color 0.3s ease;
}

.dark .template-card-footer {
...
// src/features/workflow-templates/components/WorkflowAssignment.css
...
.assignment-btn.secondary {
  background: white;
  border-color: rgba(208, 215, 230, 0.8);
  color: #475569;
}
...
.panel-header {
  ...
  align-items: center;
  padding: 16px 20px;
  border-bottom: 1px solid rgba(208, 215, 230, 0.6);
}
...
.person-item:hover:not(.assigned) {
  border-color: rgba(99, 102, 241, 0.4);
